...
//       <div className="relative w-full bg-white h-full my-6 overflow-hidden break-after-page">
//   <div className="">
//     <Image
//       src={cover}
...
//                         <>
//                           <tr>
//                             <td className="border border-1 p-2 text-md text-center font-bold bg-slate-300">
//                               Political
//                             </td>
