  ...
  return (
    <div className="relative w-full border border-blue-default bg-white lg:max-w-6xl my-6 lg:rounded-lg shadow-lg h-screen overflow-hidden">
      <div className="relative w-full overflow-hidden">
        <Image src={cover} alt="Cover page image" className="w-full h-screen object-cover" />
      </div>
      <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-between p-8 text-white">
        <div className="flex justify-between">
          <div className="flex flex-col items-start">
            ...
            <h2 className="text-xl font-bold mt-2 text-black">{projectData?.name}</h2>
          </div>
          <h1 onClick={() => router.push(`/components/Preview/${id}`)} className="text-black cursor-pointer">
            Continue to project
          </h1>
        </div>
