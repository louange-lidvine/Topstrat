                ...
                <div className="flex flex-col gap-6">
                    <div className="flex flex-col gap-4 ">
                        ...
                        <p className="">
                            ...
                            husbandry, and access to suitable land, the project
                            is poised to tap into the local demand for
                            high-quality rabbit meat. While facing initial
                            constraints in capital and brand recognition, the
                            project anticipates capitalizing on a growing trend
                            towards healthier meats and potential for
                            value-added products. Government subsidies and
                            export opportunities further bolster the venture.
                        </p>
                    </div>
                    <div className="flex flex-col gap-3">
                        <h3 className="text-xl font-bold"> Vision</h3>
                        <p>
                            "To create a sustainable and prosperous rabbit
                            farming community, providing economic empowerment
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <p>
                            "Our mission is to implement best practices in
                            rabbit husbandry, provide comprehensive training,
                            and establish market linkages for the benefit of the
                            community"
                        </p>
                    </div>
                </div>
